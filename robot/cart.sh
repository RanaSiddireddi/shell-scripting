...
curl -s -L -o /tmp/$COMPONENT.zip "https://github.com/stans-robot-project/cart/archive/main.zip"
stat $?
...
sed -i -e 's/CATALOGUE_ENDPOINT/catalogue.roboshop.internal/' -e 's/REDIS_ENDPOINT/redis.roboshop.internal/'  /home/$APPUSER/$COMPONENT/systemd.service &>> "$LOGFILE"
